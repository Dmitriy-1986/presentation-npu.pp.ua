function sliderFunction() {
    const data = [
        "Стаття 46. Застосування вогнепальної зброї. <br> 4. Поліцейський уповноважений у виняткових випадках застосовувати вогнепальну зброю: <br> 1) для відбиття нападу на поліцейського або членів його сім’ї, у випадку загрози їхньому життю чи здоров’ю;",
